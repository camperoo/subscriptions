...
describe Subscriptions::Invoice do
  ...
  it ".due_today" do
    ...
    invoice_failed_1_retry = FactoryGirl.create(:invoice, invoice_end_date: Date.today, retries: 1, status: :failed)
  ...
  it ".to_retry" do
    ...
    invoice_complete_2_retry = FactoryGirl.create(:invoice, invoice_end_date: Date.today - 5, retries: 2, status: :complete)
    invoice_failed_4_retry = FactoryGirl.create(:invoice, invoice_end_date: Date.today - 4, retries: 4, status: :failed)
